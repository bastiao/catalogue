...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('control_version_bugreport', (
        ...
        db.send_create_signal('control_version', ['BugReport'])


    def backwards(self, orm):
        # Deleting model 'BugReport'
        db.delete_table('control_version_bugreport')
